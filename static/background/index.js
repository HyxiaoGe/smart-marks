...
function $a52c22cac21bde54$export$69cf574f30fda100(path, pattern, ignoreCase = true) {
    // \u5982\u679c\u6a21\u5f0f\u4e0d\u5305\u542b\u901a\u914d\u7b26\uff0c\u8fdb\u884c\u7cbe\u786e\u5339\u914d
    if (!pattern.includes("*") && !pattern.includes("?")) {
        ...
        } else return path === pattern || path.endsWith("/" + pattern) || path.split("/").includes(pattern);
    }
    ...
    if (pattern.endsWith("/*")) {
        ...
        } else return path.startsWith(parentFolder + "/") || path.includes("/" + parentFolder + "/");
    }
    // \u5c06\u901a\u914d\u7b26\u6a21\u5f0f\u8f6c\u6362\u4e3a\u6b63\u5219\u8868\u8fbe\u5f0f
...
async function $a52c22cac21bde54$export$14098a650fd835e3(bookmark, filterSettings) {
    ...
    // \u68c0\u67e5\u662f\u5426\u5339\u914d\u6392\u9664\u6a21\u5f0f
    for (const pattern of filterSettings.excludePatterns)if ($a52c22cac21bde54$export$69cf574f30fda100(folderPath, pattern, filterSettings.ignoreCase)) {
