 ...
 */ function $bbc91b5d8b31594e$var$OptionsPage() {
    ...
    const toggleFolderExclusion = (folderPath)=>{
        setFilterSettings((prev)=>{
            ...
            if (isCurrentlyExcluded) // \u5982\u679c\u5f53\u524d\u6587\u4ef6\u5939\u88ab\u6392\u9664\uff0c\u5219\u53d6\u6d88\u6392\u9664\u5b83\u548c\u6240\u6709\u5b50\u6587\u4ef6\u5939
            newExcludeFolders = newExcludeFolders.filter((path)=>path !== folderPath && !path.startsWith(folderPath + "/"));
                ...
                // \u81ea\u52a8\u6dfb\u52a0\u6240\u6709\u5b50\u6587\u4ef6\u5939
                const childFolders = bookmarkFolders.filter((folder)=>folder.path.startsWith(folderPath + "/")).map((folder)=>folder.path);
                newExcludeFolders = [
                    ...new Set([
                        ...newExcludeFolders,
                        ...childFolders
                                    ...
                                    /*#__PURE__*/ (0, $96OZm$jsxs)("ul", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, $96OZm$jsx)("li", {
                                                children: "*temp* - \u5339\u914d\u4e34\u65f6\u6587\u4ef6\u5939"
                                            }),
                                            /*#__PURE__*/ (0, $96OZm$jsx)("li", {
                                                children: "\u5de5\u4f5c/* - \u5339\u914d\u5de5\u4f5c\u6587\u4ef6\u5939\u4e0b\u7684\u6240\u6709\u5b50\u6587\u4ef6\u5939"
                                            }),
                                            /*#__PURE__*/ (0, $96OZm$jsx)("li", {
