...
\u8f93\u5165\u4f60\u7684\u89c4\u5219:`);
    ...
    const isMatchedByPattern = (folderPath)=>{
        return filterSettings.excludePatterns.some((pattern)=>{
            // \u5982\u679c\u6a21\u5f0f\u4e0d\u5305\u542b\u901a\u914d\u7b26\uff0c\u8fdb\u884c\u7cbe\u786e\u5339\u914d
            if (!pattern.includes("*") && !pattern.includes("?")) // \u7cbe\u786e\u5339\u914d\uff1a\u5b8c\u6574\u8def\u5f84\u5339\u914d\u6216\u6587\u4ef6\u5939\u540d\u79f0\u5339\u914d
            return folderPath === pattern || folderPath.endsWith("/" + pattern) || folderPath.split("/").includes(pattern);
            // \u5904\u7406 "folder/*" \u6a21\u5f0f\uff08\u5339\u914dfolder\u4e0b\u7684\u6240\u6709\u5b50\u6587\u4ef6\u5939\uff09
            if (pattern.endsWith("/*")) {
                const parentFolder = pattern.slice(0, -2); // \u79fb\u9664 /*
                // \u68c0\u67e5\u8def\u5f84\u662f\u5426\u4ee5 parentFolder/ \u5f00\u5934\uff08\u5b50\u6587\u4ef6\u5939\uff09
                return folderPath.startsWith(parentFolder + "/") || folderPath.includes("/" + parentFolder + "/");
            }
            // \u5c06\u901a\u914d\u7b26\u6a21\u5f0f\u8f6c\u6362\u4e3a\u6b63\u5219\u8868\u8fbe\u5f0f
    ...
    const addCommonPrivacyRules = ()=>{
        ...
        // \u53ea\u6dfb\u52a0\u5f53\u524d\u4e0d\u5b58\u5728\u7684\u89c4\u5219
        setFilterSettings((prev)=>{
            const newPatterns = commonPatterns.filter((pattern)=>!prev.excludePatterns.includes(pattern));
