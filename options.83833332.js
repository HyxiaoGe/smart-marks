...
\u8f93\u5165\u4f60\u7684\u89c4\u5219:`);
        ...
        return filterSettings.excludePatterns.some((pattern)=>{
            ...
            if (!pattern.includes("*") && !pattern.includes("?")) {
                ...
                if (filterSettings.ignoreCase) {
                    ...
                    return lowerPath === lowerPattern || lowerPath.endsWith("/" + lowerPattern) || lowerPath.split("/").includes(lowerPattern);
                } else return folderPath === pattern || folderPath.endsWith("/" + pattern) || folderPath.split("/").includes(pattern);
            }
            ...
            if (pattern.endsWith("/*")) {
                ...
                if (filterSettings.ignoreCase) {
                    ...
                    return lowerPath.startsWith(lowerParent + "/") || lowerPath.includes("/" + lowerParent + "/");
                } else return folderPath.startsWith(parentFolder + "/") || folderPath.includes("/" + parentFolder + "/");
            }
            // \u5c06\u901a\u914d\u7b26\u6a21\u5f0f\u8f6c\u6362\u4e3a\u6b63\u5219\u8868\u8fbe\u5f0f
            let regexPattern = pattern.replace(/[.+^${}()|[\]\\]/g, "\\$&") // \u8f6c\u4e49\u7279\u6b8a\u5b57\u7b26
            .replace(/\*/g, ".*").replace(/\?/g, ".");
            // \u5982\u679c\u6a21\u5f0f\u4ee5 * \u5f00\u5934\u6216\u7ed3\u5c3e\uff0c\u5141\u8bb8\u90e8\u5206\u5339\u914d
    ...
    const clearAllSelections = ()=>{
        if (window.confirm("\u786e\u5b9a\u8981\u6e05\u7a7a\u6240\u6709\u52fe\u9009\u7684\u6587\u4ef6\u5939\u5417\uff1f\u8fd9\u5c06\u6e05\u9664\u6240\u6709\u624b\u52a8\u52fe\u9009\u7684\u6587\u4ef6\u5939\uff0c\u4f46\u4e0d\u4f1a\u5220\u9664\u81ea\u5b9a\u4e49\u89c4\u5219\u3002")) setFilterSettings((prev)=>({
                ...prev,
                excludeFolders: []
            }));
    };
    ...
    const clearAllSettings = ()=>{
        if (window.confirm("\u786e\u5b9a\u8981\u6e05\u7a7a\u6240\u6709\u8bbe\u7f6e\u5417\uff1f\u8fd9\u5c06\u6e05\u9664\u6240\u6709\u52fe\u9009\u7684\u6587\u4ef6\u5939\u548c\u81ea\u5b9a\u4e49\u89c4\u5219\u3002")) setFilterSettings((prev)=>({
                ...prev,
                excludeFolders: [],
                excludePatterns: []
            }));
                                ...
                                children: bookmarkFolders.map((folder)=>/*#__PURE__*/ (0, $96OZm$jsxs)("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, $96OZm$jsx)("input", {
                                                ...
                                                title: isMatchedByPattern(folder.path) && !filterSettings.excludeFolders.includes(folder.path) ? "\u6b64\u6587\u4ef6\u5939\u88ab\u81ea\u5b9a\u4e49\u89c4\u5219\u5339\u914d\uff0c\u8bf7\u5220\u9664\u5bf9\u5e94\u89c4\u5219\u6765\u53d6\u6d88\u52fe\u9009" : ""
                                            }),
